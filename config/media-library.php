...
use App\MediaLibrary\PostPathGenerator;
use App\MediaLibrary\SeoPathGenerator;
use App\Models\Post;
use App\Models\Seo;
...
return [
    ...
    'custom_path_generators' => [
        ...
        Post::class => PostPathGenerator::class,
        Seo::class => SeoPathGenerator::class,
    ],
    ...
    'posts-prefix' => env('POSTS_MEDIA_PREFIX', 'posts'),
    'seo-prefix' => env('SEO_MEDIA_PREFIX', 'seo'),
