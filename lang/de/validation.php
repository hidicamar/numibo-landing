...
return [
    ...
    'doesnt_contain' => ':Attribute darf :values nicht enthalten.',
    ...
    'attributes' => [
        ...
        'amount' => 'Anzahl der Aufgaben',
        'difficulty' => 'Schwierigkeit',
        'carryover' => 'Übertrag',
        'quantityType' => 'unbekannte Menge',
        'numberOfDigits' => 'Stellenanzahl',
        'dividend' => 'Dividend',
        'divisor' => 'Divisor',
        ...
        'numbers' => 'Zahlen',
        'numbers.*' => 'Zahl',
        'solutionsIncluded' => 'Lösungen',
        'answers' => 'Antworten',
        'answers.*' => 'Antwort',
        'remainderAnswers.*' => 'Rest',
    ...
    'custom' => [
        'google' => [
            'failed' => 'Die Google-Anmeldung ist fehlgeschlagen. Bitte versuchen Sie es erneut.',
            'account_deleted' => 'Dieses Konto wurde gelöscht und kann nicht mehr zur Anmeldung verwendet werden.',
        ],
        'dividend' => [
            'required_if' => 'Das Feld Dividend ist erforderlich, wenn Division ausgewählt ist.',
        ],
        'divisor' => [
            'required_if' => 'Das Feld Divisor ist erforderlich, wenn Division ausgewählt ist.',
        ],
        'remainder' => [
            'required_if' => 'Das Feld Rest ist erforderlich, wenn Division ausgewählt ist.',
        ],
        'multiplicand' => [
            'required_if' => 'Das Feld Multiplikand ist erforderlich, wenn Multiplikation ausgewählt ist.',
        ],
        'multiplier' => [
            'required_if' => 'Das Feld Multiplikator ist erforderlich, wenn Multiplikation ausgewählt ist.',
        ],
        'carryover' => [
            'required_if' => 'Das Feld Übertrag ist erforderlich, wenn Multiplikation ausgewählt ist.',
        ],
    ],
];
